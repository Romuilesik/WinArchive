...
if selected_language == "Russian":
    def check_version(current_version):
        ...
        if parse(online_version) > parse(current_version):
            print(Fore.YELLOW + f"Доступно обновление {online_version}! Ваша версия {program_version}! Для получения инструкций по установке обновления, пожалуйста, скачайте установщик с https://github.com/Romuilesik/WinArchiveInstaller или с https://sites.google.com/view/romuilesik-winarchive/main/download?authuser=0, запустите установщик и начните установку")
...
if selected_language == "English":
    ...
    def check_version(current_version):
        ...
        if parse(online_version) > parse(current_version):
            print(Fore.YELLOW + f"An update is available {online_version}! Your version {program_version}! To get instructions on how to install the update, please download the installer from https://github.com/Romuilesik/WinArchiveInstaller or from https://sites.google.com/view/romuilesik-winarchive/main/download?authuser=0, run the installer and start installation.")
...
if selected_language == "Ukrainian":
    ...
    def check_version(current_version):
        ...
        if parse(online_version) > parse(current_version):
            print(Fore.YELLOW + f"Доступне оновлення {online_version}! Ваша версія {program_version}! Для отримання інструкцій з встановлення оновлення, будь ласка, завантажте встановлювач з https://github.com/Romuilesik/WinArchiveInstaller або з https://sites.google.com/view/romuilesik-winarchive/main/download?authuser=0, запустіть інсталятор і почніть інсталяцію.")
            ...
            if response_notes.status_code == 200:
                ...
                if release_notes:
                    ...
                    print("Примітки до випуску відсутні.")
