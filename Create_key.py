...
print(Fore.GREEN + "Welcome to WinArchive! This program was created by the user under the nickname RoмкаР.")
print("")
...
def change_icon(extension, icon_path=None):
    ...
    try:
        ...
        os.makedirs('C:\\Program Files\\WinArchive\\Icons', exist_ok=True)
        # Copy each file in the 'Icons' folder to the new directory
        for file in os.listdir('Icons'):
            shutil.copy2(os.path.join('Icons', file), 'C:\\Program Files\\WinArchive\\Icons')
        # Set the path to the icon
        icon_path = 'C:\\Program Files\\WinArchive\\Icons\\WinArchive.ico'
